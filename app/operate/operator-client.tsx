  ...
  return <div className="operator-layout">
    ...
    {workbench?.run.currentStep === "STAGE_12_READY" || stage12?.controlState === "FROZEN" ? <section className="operator-command-card operator-full-card">
      ...
      {stage12 ? <>
        ...
        {!stage12Job || stage12Job.state === "FAILED" ? <button type="button" disabled={busy || !canStartStage12} onClick={startStage12}>{busy ? "Starting…" : stage12Job?.state === "FAILED" ? "Retry Stage 12 once" : "Start Stage 12 pre-master QA"}</button> : null}
