  ...
  return (
    <main>
      <header className="topbar">
        ...
        <div className="topbar-actions"><span className="mode-pill"><i /> OPERATE · G-01A1</span><Link className="repo-link" href="/">Control plane</Link></div>
      </header>
      <section className="operator-shell">
        <div className="operator-title-row">
          ...
          <p>Authenticated commands write to Production D1 and return an append-only receipt. No code change is required for an operational run.</p>
        </div>
        <OperatorClient />
      </section>
    </main>
