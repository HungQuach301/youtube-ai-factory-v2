...
| `04-BUILD-ORDER.md` | **v2** — 38 work package, hai track, điểm dừng bắt buộc |
...
| `17-STAGE12-QA-REMEDIATION.md` | Evolution Stage 12: immutable QA, diagnostic replay, codec-safe true-peak, LRA guard và feasibility shadow |
